<?php
  ...
  if($_SERVER['REQUEST_METHOD'] === 'POST'){
      ...
      $sql = "SELECT * FROM labs where password = '$pswd' AND lab_name='$lab'";
...
<body>
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link" href="index.php" active>Search</a>
    </li>
  </ul>
        ...
        <div class="col col-sm-6 col-md-6 col-lg-4 col-xl-3">
            ...
            <form action="" method="POST">
                <div class="form-group">
                    <input _ngcontent-c0="" class="form-control form-control-lg" placeholder="Lab Name*" type="type" name="lab" required>
                </div>
                 <div class="form-group">
